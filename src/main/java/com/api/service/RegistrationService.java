...
import com.api.exception.ResponceNotFoundException;
...
//        dto.setMobile(registration.getMobile());
   ...
   public RegistrationDto getRegistrationById(long id){
        Registration registration = registrationRepository.findById(id).orElseThrow(()->new ResponceNotFoundException("Record not found"));
